...
function AdminUsersContent() {
  console.log("AdminUsersContent component rendered!")
  ...
  if (typeof window !== 'undefined') {
    console.log("Window is available, testing direct API call...")
  }
  ...
  useEffect(() => {
    ...
    console.log("Dependencies:", { currentPage, searchQuery, selectedRole })
    // Fetch users regardless of authentication status for testing
    fetchUsers()
  }, [fetchUsers])
